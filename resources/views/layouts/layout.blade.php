...
scratch. This page gets rid of all s and provides the needed markup only.
-->
<html>
...
<head>
    ...
    <title>Parqueadero Warrior´s</title>
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="/" class="logo">
                ...
                <span class="logo-lg"><b>P</b>arking</span>
            </a>
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="active"><a href="/empleado"><i class="fa fa-link"></i> <span>Empleados</span></a></li>
                    <li class="treeview">
